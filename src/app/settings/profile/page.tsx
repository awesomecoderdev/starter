...
export default function Profile() {
	return (
		<form className="py-3 space-y-6" action="#" method="POST">
					...
					<div className="mt-5 space-y-6 md:col-span-2 md:mt-0">
						...
						<div>
							...
							<div className="mt-1 flex items-center space-x-5">
								...
								<button
									type="button"
									className="rounded-md border border-gray-300 bg-white py-2 px-3 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
								>
									Change
								</button>
							</div>
			...
			<div className="px-4 py-5 shadow dark:border border-zinc-900/7.5 dark:border-white/7.5 sm:rounded-lg sm:p-6">
				<div className="md:grid md:grid-cols-3 md:gap-6">
					<div className="md:col-span-1">
						<h3 className="text-lg font-medium leading-6 text-gray-900">
