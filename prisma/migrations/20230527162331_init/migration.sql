...
CREATE TABLE `Website` (
    ...
    INDEX `Website_password_idx`(`password`),
    INDEX `Website_createdAt_idx`(`createdAt` DESC),
    INDEX `Website_scaned_idx`(`scaned` DESC),
    INDEX `Website_userId_idx`(`userId`),
    UNIQUE INDEX `Website_domain_key_key`(`domain`, `key`),
    FULLTEXT INDEX `Website_key_endpoint_idx`(`key`, `endpoint`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
